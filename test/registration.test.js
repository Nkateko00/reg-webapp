...
describe("Registration function", function () {
    ...
    it("should add more than one registrations to  database", async function () {
        ...
        assert.deepEqual([{ reg_number: "CJ 123456" }], [{ reg_number: 'CJ 123456' }], [{ reg_number: 'CY 2345' }], [{ reg_number: 'CA 876-568' }],
         allRegistration);
    });
    ...
    it("should  filter all Bellville registrations ", async function () {
        ...
        assert.deepEqual([{ reg_number: "CY 2345" }],[{ reg_number: "CY 2345" }], [{ reg_number: "CY 12345" }],
    ...
    it("should reset the dataBase", async function () {
        ...
        await reg.addRegistration('CA 12345');
        await reg.addRegistration('CJ 1234');
